...
static CoreDataProvider *instance = nil;
...
+ (CoreDataProvider *) instance{
    if (instance == nil) {
        instance = [[CoreDataProvider alloc] init];
    }
    return instance;
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MySocialFeeds" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MySocialFeeds.sqlite"];
